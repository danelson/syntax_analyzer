...
class Parser:
    ...
    def anyOf(self, tokens):
        ...
        (e.g. for processing all declarations) or any of a set of
        operators.)
    ...
    def ifStatement(self):
        ...
        @return: a list of an Equality object and a list of
                 Conditonal Objects
        '''
        conditional = []
    ...
    def factor(self):
        ...
        Concrete syntax:
        [ UnaryOp ] Primary
        @return: either a Unary object or a return value from down
                 the tree object
        '''
    ...
    def primary(self):
        ...
        @return: a Variable object, a Literal object, or another
                 return value that goes back down the tree
        '''
