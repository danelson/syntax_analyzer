...
class Lexer:
    ...
    def nextToken(self):
        '''
        Reads the next line from a file and splits it based on the
        first '-' character. It builds a token object from its type
        and value. When we reach the end of the file create a
