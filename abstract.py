...
class Program:
    '''
    Responsible for printing the program header and calling any of
...
class Declaration:
    '''
    Responsible for printing the declaration header and calling any
    of its nodes in the tree.
    '''
    
    def __init__(self, variable=None, type=None):
        '''
        Initializes the Declaration class with a variable and a
        vartype
        @variable: a string
        @vartype: a string
        '''
...
class Elsestatement:
    '''
    Responsible for printing the else statment header and calling
    any of its nodes in the tree.
    '''
...
class Comparison:
    ...
    def printTree(self, indent):
        ...
        @indent: the formatting for indentation
        '''
        print "{0}|-Comparison : {1}".format(indent, self.op.value)
...
class Variable:
    ...
    def printTree(self, indent):
        ...
        if isinstance(self.var,token.Token):
            print "{0}|-Variable : {1}".format(indent, self.var.value)
...
class Operator:
    ...
    def printTree(self, indent):
        ...
        @indent: the formatting for indentation
        '''
        print "{0}|-Operator : {1}".format(indent, self.op.value)
...
class Type:
    ...
    def printTree(self, indent):
        ...
        @indent: the formatting for indentation
        '''
        print "{0}|-Type : {1}".format(indent, self.type.value)
...
class Integer:
    ...
    def printTree(self, indent):
        ...
        @indent: the formatting for indentation
        '''
        print "{0}|-Integer : {1}".format(indent, self.val.value)
...
class Float:
    ...
    def printTree(self, indent):
        ...
        @indent: the formatting for indentation
        '''
        print "{0}|-Float : {1}".format(indent, self.val.value)
